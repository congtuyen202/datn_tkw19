                ...
                <div class="box_contact">
                  <div class="mb-3">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div v-for="(item, index) in test" class="wrapper-item">
                        <div class="row">
                          <div class="col-6">
                            <div class="mb-2">
                              ...
                              <Field type="text" v-model="item.title_skill" rules="required"
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="mb-2">
                            ...
                            <Editor :name="'project_detail[' + index + ']'" v-model="model.project_detail" class="
                                form-control
                                cus-tom-ckediter-cv
                                input-skill
